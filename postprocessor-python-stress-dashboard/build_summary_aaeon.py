#!/usr/bin/env python3
"""Aggregate the AAEON-NX stress-run CSVs into a 5-model comparison (md + html + csv).
Runs ON the AAEON-NX box right after the sweep. Output dir = /home/aaeon/stress-reports."""
import csv, glob, os, statistics, html, re

DIR = "/home/aaeon/stress-reports"
PREFIX = "AAEON-PTL-U5-336H"          # must match stress_harness --label
DEVICE = "cpu"
...
# ---- build Markdown ----
md = []
md.append("# Nx AI Manager Stress Test — AAEON-NX 5-Model Comparison\n")
md.append(f"**Host:** {HW}  ")
...
<title>Stress Test — AAEON-NX 5-Model Comparison</title>
<style>
...
<h1>Nx AI Manager Stress Test — AAEON-NX 5-Model Comparison</h1>
