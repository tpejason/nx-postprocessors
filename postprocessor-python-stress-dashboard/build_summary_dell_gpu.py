#!/usr/bin/env python3
"""Aggregate the DELL iGPU stress-run CSVs into a 4-model comparison (md+html+csv).
...
# ---- Markdown ----
md = []
md.append("# Nx AI Manager Stress Test — DELL iGPU 4-Model Comparison\n")
md.append(f"**Host:** {HW}  ")
...
<title>Stress Test — DELL iGPU 4-Model</title>
<style>
...
<h1>Nx AI Manager Stress Test — DELL iGPU (4 YOLO11s models)</h1>
