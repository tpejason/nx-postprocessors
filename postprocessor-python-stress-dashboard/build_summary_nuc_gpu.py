#!/usr/bin/env python3
"""Aggregate the ASUS-NUC iGPU stress-run CSVs into a 4-model comparison (md+html+csv).
iGPU sweep, YOLO11s-based People/Vehicle models only (no Demo/Face — they have no GPU build).
Output: SUMMARY-igpu.{md,html,csv} in /home/nx/stress-reports (does NOT touch the CPU SUMMARY)."""
import csv, glob, os, statistics, html, re

DIR = "/home/nx/stress-reports"
PREFIX = "ASUS-NUC-U5-125H"
DEVICE = "gpu"
...
# ---- Markdown ----
md = []
md.append("# Nx AI Manager Stress Test — ASUS-NUC iGPU 4-Model Comparison\n")
md.append(f"**Host:** {HW}  ")
...
<title>Stress Test — ASUS-NUC iGPU 4-Model</title>
<style>
...
<h1>Nx AI Manager Stress Test — ASUS-NUC iGPU (4 YOLO11s models)</h1>
